...
주제는 <b>직접 재는 방법</b>으로 한 것이지만, <b>여덟 칸의 틀은 어떤 방법이든 똑같습니다.</b></div>
...
<tr><td>3</td><td>「사운드 센서 배선도와 예제 스케치」 · 담당 교사 배부 자료 · 2026</td></tr>
</table>
</div></div>
...
<section class="learn">
<h2>같은 여덟 칸을 다른 방법으로 쓰면</h2>
<p class="lead"><b>틀은 똑같습니다.</b> 무엇을 채우는지만 달라져요.</p>
<table>
<tr><th>칸</th><th>직접 재기 <span style="font-weight:400">(위 보고서)</span></th><th>있는 자료 분석</th><th>프로그램 제작</th></tr>
...
<div class="box">💡 <b>⑤ 결과 해석 · ⑥ 한계 · ⑦ 알게 된 점은 어떤 방법이든 완전히 똑같습니다.</b><br>
연구의 값어치가 갈리는 곳도 바로 거기입니다.</div>
</section>
